...
const Footer: React.FC = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-[#00131a] pt-20 lg:pt-[100px]"
      data-wow-delay=".15s"
    >
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <Link to="#" className="mb-6 inline-block max-w-[50px]">
                <img src="/img/logo.png" alt="logo" className="max-w-full" />
              </Link>
              <p className="mb-8 max-w-[270px] text-base text-gray-100">
              MERN stack developer & React.js expert. Passionate about clean code, dynamic UI/UX, and turning ideas into solutions.
              </p>
              <div className="-mx-3 flex items-center">
                <Link to="https://github.com/Ajay-Dhangar" className="px-3 text-gray-7 hover:text-white">
                  <svg
                    width="22"
                    height="22"
                    viewBox="0 0 24 24"
                ...
                <Link to="https://x.com/CodesWithAjay" className="px-3 text-gray-7 hover:text-white">
                  <svg
                    width="22"
                    height="22"
                    viewBox="0 0 22 22"
                ...
                <Link to="https://www.instagram.com/_ajay.dhangar/" className="px-3 text-gray-7 hover:text-white">
                  <svg
                    width="22"
                    height="22"
                    viewBox="0 0 22 22"
                ...
                <Link to="https://www.linkedin.com/in/ajay-dhangar/" className="px-3 text-gray-7 hover:text-white">
                  <svg
                    width="22"
                    height="22"
                    viewBox="0 0 22 22"
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10 w-full">
              ...
              <ul className="list-none pl-0">
                <li>
                  <Link to="#" className="mb-3 inline-block text-base">
                    Skill Assessment
                  </Link>
                </li>
                <li>
