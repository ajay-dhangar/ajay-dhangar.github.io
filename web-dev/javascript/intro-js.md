...
import img1 from "/img/website.svg";
...
<html>
  <body>
    ...
    <button
      type="button"
      onclick="document.getElementById('myImage').src='/img/about_me_re.svg"
    >
      Change Image
    </button>
  </body>
...
<h1>My First JavaScript</h1>
    <img
      ...
      height="auto"
    />
    <button onClick={()=> document.getElementById('myImage').src='/img/about_me_re.svg'}>
      Change Image
    </button>
</BrowserWindow>
