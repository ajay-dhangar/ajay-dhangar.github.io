...
`,g=p.cp.span`
    font-size: 14px;
`,f=e=>{let{collections:t}=e;return(0,o.jsx)("div",{children:t.map(((e,t)=>(0,o.jsxs)(b,{href:e.url,target:"_blank",rel:"noopener noreferrer",children:[(0,o.jsx)(j,{children:e.label}),(0,o.jsx)(g,{children:e.url})]},t)))})};var y=n(97512);const v=p.cp.div`
  margin: 5px;
`,w=p.cp.div`
  margin: 10px 0;
  display: flex;
