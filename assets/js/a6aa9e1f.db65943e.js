...
`,j=m.cp.span`
    font-size: 14px;
`,f=e=>{let{collections:t}=e;return(0,o.jsx)("div",{children:t.map(((e,t)=>(0,o.jsxs)(g,{href:e.url,target:"_blank",rel:"noopener noreferrer",children:[(0,o.jsx)(b,{children:e.label}),(0,o.jsx)(j,{children:e.url})]},t)))})};var v=n(97512);const y=m.cp.div`
  margin: 5px;
`,w=m.cp.div`
  margin: 10px 0;
  display: flex;
